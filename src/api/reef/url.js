...
const jobFilter = ['id', 'test_area', 'test_area.description', 'custom_tag', 'custom_tag.custom_tag_name', 'ui_json_file', 'job_name', 'job_type', 'job_second_type', 'draft', 'updated_time', 'author', 'author.id','author.username']
